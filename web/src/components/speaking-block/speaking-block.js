  ...
  <>
    <div className={styles.speakingBlock}>
      ...
      <p>
        ...
        and around the North of England, <a href="https://youtu.be/s6zjiMvZZ4A?t=286" target="_blank">some of which are on YouTube</a>.
        I like to talk about Web Development, Diabetes, Careers in Web Development and much more.
      </p>

      <h3>Upcoming Events</h3>
      <p><b>JAMstack_conf London Welcome Drinks - 9th July 2019</b></p>
      <p>
        I'll be speaking at the JAMstack_conf London welcome drinks event on the evening of
        9th July at <a href="https://goo.gl/maps/x7YNoEyu1W5uLn1f6" target="_blank">Turners Old Star Pub</a>{' '}
